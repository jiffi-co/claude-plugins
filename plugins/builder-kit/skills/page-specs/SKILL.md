...
4. Use the UI/UX Pro Max skill to generate each spec from the design system's components and tokens (do not invent components the design system does not define).
