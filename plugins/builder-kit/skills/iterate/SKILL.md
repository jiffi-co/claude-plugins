...
- docs/, ADRs, the acceptance checklist and Beads are the source of truth. Ground in the files, not in chat memory, and never overstate what the live code already does.
...
- `docs/implementation-plan.md`: appended feature phases. `docs/checkpoints/phase-<N>.json` and one Beads issue per new phase.
